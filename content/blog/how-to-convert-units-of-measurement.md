---
title: "How to Convert Units of Measurement: Length, Weight, Temperature & Data"
date: "2026-04-19"
excerpt: "Learn how to convert units of measurement for length, weight, temperature, and data storage — with conversion factors, worked examples, and a quick-reference table."
---
...
Mental math shortcuts work for estimates. For precise results — on a visa form, a medical chart, or a recipe — use the [CalcKit unit converter](/unit-converter) to avoid rounding errors.
...
**42 km marathon → miles**
42 km × 0.621371 = **26.1 miles**

The classic rule of thumb: multiply km by 0.6 for a quick estimate.

**180 cm → feet and inches**
180 ÷ 2.54 = 70.87 inches → **5 feet 10.9 inches** (commonly rounded to 5'11")
...
**37°C (body temperature) → Fahrenheit**
(37 × 9/5) + 32 = (37 × 1.8) + 32 = 66.6 + 32 = **98.6°F**

**72°F (room temperature) → Celsius**
(72 − 32) × 5/9 = 40 × 0.5556 = **22.2°C**
...
**2 GB file in MB:**
2 GB × 1,024 = **2,048 MB** (binary gigabytes)
