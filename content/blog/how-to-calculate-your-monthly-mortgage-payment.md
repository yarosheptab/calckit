...
date: "2026-04-19"
excerpt: "Learn how to calculate monthly mortgage payment using the amortization formula, with a real $400k example showing full PITI cost breakdown."
---
...
1. (1 + 0.005625)^360 = 7.6878
2. Numerator: 0.005625 × 7.6878 = 0.04325
3. Denominator: 7.6878 − 1 = 6.6878
4. M = $360,000 × (0.04325 ÷ 6.6878) = $360,000 × 0.006468 = **$2,328/month**
...
1. **Gather inputs** — home price, down payment, rate, term
2. **Calculate principal** — home price minus down payment
3. **Convert rate** — divide annual APR by 12
4. **Apply the formula** — M = P[r(1+r)^n]/[(1+r)^n−1]
5. **Add PITI components** — taxes, insurance, and PMI for the real number
