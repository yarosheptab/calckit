---
title: "Percentage Calculator: How to Calculate Any Percentage Instantly"
date: "2026-04-05"
excerpt: "Master every percentage calculation with our free percentage calculator. Covers what is X% of Y, percent change, percentage points, and real-world examples."
---
...
**Example:** 30 correct out of 200 questions — what percentage is that?
Percent = (30 ÷ 200) × 100 = **15%**
...
**Example:** A stock rises from $50 to $65. What is the percentage change?
...
| Percentage | Mental Math Shortcut | Example (base: 240) |
|---|---|---|
| 1% | Move decimal left two places | 2.4 |
| 5% | Half of 10% | 12 |
| 10% | Move decimal left one place | 24 |
| 20% | Double the 10% figure | 48 |
| 25% | Divide by 4 | 60 |
| 50% | Divide by 2 | 120 |
| 75% | Three times 25% | 180 |
...
Your salary is $65,000. You negotiate a 7% raise. New salary:
65,000 × 1.07 = **$69,550** (+$4,550)
...
**Percentage points** are the arithmetic difference between two percentages.
**Percentage change** is the relative change from a starting percentage.
