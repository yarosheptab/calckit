          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              '@graph': [
                {
                  '@type': 'WebSite',
                  '@id': 'https://calckit.yaro-labs.com/#website',
                  name: 'calckit',
                  url: 'https://calckit.yaro-labs.com',
                  description: siteDescription,
                  inLanguage: 'en-US',
                  publisher: { '@id': 'https://calckit.yaro-labs.com/#organization' },
                  potentialAction: {
                    '@type': 'SearchAction',
                    target: { '@type': 'EntryPoint', urlTemplate: 'https://calckit.yaro-labs.com/blog?q={search_term_string}' },
                    'query-input': 'required name=search_term_string',
                  },
                },
                {
                  '@type': 'Organization',
                  '@id': 'https://calckit.yaro-labs.com/#organization',
                  name: 'calckit',
                  url: 'https://calckit.yaro-labs.com',
                  ...
                  sameAs: [
                    ...
                    'https://fazier.com/launches/calckit',
                    'https://dang.ai',
                    'https://twelve.tools',
                    'https://findly.tools/calckit',
                  ],
                },
              ],
            }),
