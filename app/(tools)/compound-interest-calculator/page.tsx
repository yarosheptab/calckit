...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Compound Interest Calculator — Future Value & Growth',
    description: 'Calculate how investments grow with compound interest. Choose annual, monthly, or daily compounding — see future value and interest earned.',
    url: 'https://calckit.yaro-labs.com/compound-interest-calculator',
    siteName: 'calckit',
    type: 'website',
  },
  twitter: {
  ...
  '@graph': [
    {
      ...
      operatingSystem: 'Web',
      url: `${BASE}/compound-interest-calculator`,
      description: 'Calculate how investments grow with compound interest. Choose annual, monthly, or daily compounding — see future value and interest earned.',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Compound Interest Calculator', item: `${BASE}/compound-interest-calculator` },
      ],
    },
    {
      '@type': 'FAQPage',
