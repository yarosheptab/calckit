...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Debt Payoff Calculator — Credit Card & Loan Payoff',
    description: 'Calculate how long to pay off any debt and total interest paid. Find the monthly payment needed to become debt-free by a target date.',
    url: 'https://calckit.yaro-labs.com/debt-payoff-calculator',
    siteName: 'calckit',
    type: 'website',
  },
  twitter: {
  ...
  '@graph': [
    {
      ...
      operatingSystem: 'Web',
      url: `${BASE}/debt-payoff-calculator`,
      description: 'Calculate how long to pay off any debt and total interest paid. Find the monthly payment needed to become debt-free by a target date.',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Debt Payoff Calculator', item: `${BASE}/debt-payoff-calculator` },
      ],
    },
    {
      '@type': 'FAQPage',
